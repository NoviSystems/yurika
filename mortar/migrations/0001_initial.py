# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2017-12-13 13:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Not Configured'), (1, 'Configured'), (2, 'Crawling'), (3, 'Preprocessing'), (4, 'Querying'), (5, 'Finished'), (6, 'Stopped')], default=0)),
            ],
        ),
        migrations.CreateModel(
            name='Annotation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('started_at', models.DateTimeField(blank=True, null=True)),
                ('finished_at', models.DateTimeField(blank=True, null=True)),
                ('process_id', models.CharField(blank=True, max_length=50)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='analysis',
            name='crawler',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='analyses', to='mortar.Crawler'),
        ),
        migrations.AddField(
            model_name='analysis',
            name='dictionaries',
            field=models.ManyToManyField(related_name='analyses', to='mortar.Dictionary'),
        ),
        migrations.AddField(
            model_name='analysis',
            name='queries',
            field=models.ManyToManyField(related_name='analyses', to='mortar.Query'),
        ),
        migrations.AddField(
            model_name='analysis',
            name='tree_link',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='analyses', to='mortar.Tree'),
        ),
        migrations.AddField(
