# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-08-03 04:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='annotation',
            name='regexs',
            field=models.ManyToManyField(blank=True, related_name='annotations', to='mortar.Category'),
        ),
        migrations.AddField(
            model_name='annotation',
            name='termvectors',
            field=models.ManyToManyField(blank=True, related_name='annotations', to='mortar.TermVector'),
        ),
        migrations.AddField(
            model_name='annotation',
            name='words',
            field=models.ManyToManyField(blank=True, related_name='annotations', to='mortar.AIDictionaryObject'),
        ),
        migrations.AddField(
